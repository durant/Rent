...
<html lang="en">
	<head>
		<title>通用表单页面_很简洁漂亮的Bootstrap响应式后台管理系统模板UniAdmin - JS代码网</title>
		<meta charset="UTF-8" />
	...
	<body>
		...
		<!--<div id="user-nav" class="navbar navbar-inverse">-->
            <!--<ul class="nav btn-group">-->
                ...
                <!--<li class="btn btn-inverse"><a title="" href="login.php"><i class="icon icon-share-alt"></i> <span class="text">退出</span></a></li>-->
            <!--</ul>-->
        <!--</div>-->
            <!---->
		<!--<div id="sidebar">-->
			...
			<!--<ul>-->
				...
				<!--<li class="active submenu open">-->
					...
					<!--<ul>-->
						<!--<li class="active"><a href="form-common.html">通用组件</a></li>-->
